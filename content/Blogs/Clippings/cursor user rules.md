...
source: "https://gist.github.com/javayhu/9e5fb043e838c6f57955454c3f507a1d"
author:
  - "[[Gist]]"
published:
created: 2025-03-30
description: "cursor user rules. GitHub Gist: instantly share code, notes, and snippets."
tags:
  - "clippings"
---
1. **Use 'cursor\_project\_rules' as the Knowledge Base**: Always refer to cursor\_project\_rules' to understand the context of the project. Do not code anything outside of the context provided in the 'cursor\_project\_rules' folder. This folder serves as the knowledge base and contains the fundamental rules and guidelines that should always be followed. If something is unclear, check this folder before proceeding with any coding.
