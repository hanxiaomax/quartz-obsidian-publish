---
title: "browser-use/awesome-prompts: Table of awesome Browser Use prompts"
source: "https://github.com/browser-use/awesome-prompts"
author:
  - "[[GitHub]]"
published:
created: 2025-03-30
description: "Table of awesome Browser Use prompts. Contribute to browser-use/awesome-prompts development by creating an account on GitHub."
tags:
  - "clippings"
---
![Shows a black Awesome Prompts Logo in light color mode and a white one in dark color mode.](https://github.com/browser-use/awesome-prompts/raw/main/static/awesome-prompts.png)  
...
🌤️ You can the setup and try the prompts directly in the cloud! **[Try the cloud ☁︎](https://cloud.browser-use.com/)**.

Thanks to [@metehan777](https://github.com/metehan777) for the initial collection of prompts.

## Table of Contents

1. [Introduction](https://github.com/browser-use/#introduction)
2. [Web Research Prompts](https://github.com/browser-use/#web-research-prompts)
3. [E-commerce Prompts](https://github.com/browser-use/#e-commerce-prompts)
4. [Content Creation Prompts](https://github.com/browser-use/#content-creation-prompts)
5. [Data Extraction Prompts](https://github.com/browser-use/#data-extraction-prompts)
6. [Job Application Prompts](https://github.com/browser-use/#job-application-prompts)
7. [Social Media Prompts](https://github.com/browser-use/#social-media-prompts)
8. [Productivity Prompts](https://github.com/browser-use/#productivity-prompts)
9. [Form Filling Prompts](https://github.com/browser-use/#form-filling-prompts)
10. [Testing and QA Prompts](https://github.com/browser-use/#testing-and-qa-prompts)
11. [Multi-Step Workflow Prompts](https://github.com/browser-use/#multi-step-workflow-prompts)
12. [Prompt Engineering Best Practices](https://github.com/browser-use/#prompt-engineering-best-practices)
13. [Contributing](https://github.com/browser-use/#contributing)
